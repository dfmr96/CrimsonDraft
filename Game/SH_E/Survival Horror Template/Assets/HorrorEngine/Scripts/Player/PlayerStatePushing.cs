...
namespace HorrorEngine
{
    public class PlayerStatePushing : ActorState
    {
        ...
        public override void StateEnter(IActorState fromState)
        {
            ...
            m_RotationAngle = Vector3.Angle(m_DirAxis, m_ActorTransform.forward);
        ...
        public override void StateFixedUpdate()
        {
            ...
            m_Rigidbody.MoveRotation(Quaternion.RotateTowards(m_ActorTransform.rotation, Quaternion.LookRotation(m_DirAxis), m_RotationAngle * (Time.deltaTime / m_InitialDelay)));
