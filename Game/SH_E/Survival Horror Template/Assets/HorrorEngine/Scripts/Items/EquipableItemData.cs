...
namespace HorrorEngine
{
    ...
    public class EquipableItemData : ItemData
    {
        ...
        [Tooltip("If true, this item will be attached to the character when used from the inventory selecting the Equip option. This is not needed if the equipped item doesn't have a visual impact on the character")]
