...
namespace HorrorEngine
{
    ...
    public class ShapeEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty(nameof(shape.CloseShape)));
            EditorGUILayout.PropertyField(serializedObject.FindProperty(nameof(shape.DrawGizmo)));
