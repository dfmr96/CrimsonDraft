...
namespace HorrorEngine
{
    ...
    public class DialogData
    {
        ...
        [SerializeField] private DialogLine[] m_Lines;
    ...
    public class UIDialog : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (m_AppearingText) 
            {
                m_AppearingText.OnShowAll.AddListener(() =>
                {
                    OnLineShown?.Invoke();
                });
            }
        ...
        private void Update()
        {
            ...
            {
                if (m_Dialog.IsValid() && !m_Dialog.CanBeDismissed)
                {
                    return;
                }
        ...
        public void Hide()
        {
            ...
            if (m_Dialog != null && m_Dialog.PauseGame)
            { 
